...
if ( file_put_contents ( "F:\xampp\htdocs\gulf/wp-content/themes/mmsgulf2/header.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "F:\xampp\htdocs\gulf\wp-content\plugins\aceide\src\Modules/backups/themes/mmsgulf2/header_2016-11-29-14.php" ) ) ) ) {
...
?>
<!DOCTYPE html>
<html <?php if ($_GET['lang'] == 'ar'){ echo 'dir="rtl"';  }else{echo 'dir="ltr"'; }  ?>  <?php language_attributes(); ?> class="no-js">
<head>
